...
/**
 * Creates a new instance of a <code>ComponentBuilder</code> which
 * provides a chainable fluent-api to create <code>Component<code> definitions
 *
...
_.extend(ComponentBuilder.prototype, {
   ...
   *
   * @returns {ComponentBuilder} current instance of <code>ComponentBuilder</code>
   */
  ...
  /**
   * Returns a new instance of <code>Component</code> with the specified
   * name, scope, initializer and dependencies
   *
   * @returns {Component} a new instance of <code>Component</code>
   */
  build: function () {
