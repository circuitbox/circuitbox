...
(function () {
  ...
  var ComponentDefinitionBuilderFactory = require('./componentDefinitionBuilders').ComponentDefinitionBuilderFactory;
  ...
  function ComponentRegistry() {
    ...
    self.getAssemblyListFor = function getAssemblyListFor(componentName) {
      ...
      // TODO: Without TCO, this recusion chain has limitations. Need to rewrite
