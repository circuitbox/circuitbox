...
function Assembler(context) {
  var self = this,
      ...
      targetComponentName = context.targetComponentName;
  ...
  function assembleCallback(callback) {
    var definitionsToAssemble = registry.assemblyListFor(targetComponentName),
        targetComponentDefinition = _.last(definitionsToAssemble),
        dependencyNames = _.pluck(definitionsToAssemble, 'name');
